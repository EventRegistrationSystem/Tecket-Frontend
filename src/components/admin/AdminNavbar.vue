  ...
  <div class="bg-white shadow-sm d-flex align-items-center justify-content-between px-4" style="height: 4rem;">
    ...
    <div class="d-flex align-items-center">
      ...
      <div class="position-relative">
        <input type="text" placeholder="Search..." class="form-control" style="padding-left: 2.5rem; width: 16rem;" />
    ...
    <div class="d-flex align-items-center gap-3">
      ...
      <div class="d-flex align-items-center" style="cursor: pointer;" @click="toggleUserMenu">
        <img src="https://i.pravatar.cc/36" alt="User" class="rounded-circle me-2" style="width: 2rem; height: 2rem;" />
        ...
        <div v-if="isUserMenuOpen" class="position-absolute end-0 bg-dark shadow-lg rounded py-2"
          ...
          <a href="#" class="d-flex align-items-center px-4 py-2 text-white text-decoration-none user-menu-item">
