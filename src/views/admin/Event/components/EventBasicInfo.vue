<template>
  <div class="mb-4">
    <div class="mb-3">
      ...
      <input :value="eventForm.name" @input="$emit('update:eventForm', { ...eventForm, name: $event.target.value })"
        type="text" placeholder="Enter event name" class="form-control" :class="{ 'is-invalid': errors.name }" />
    ...
    <div class="mb-3">
      ...
      <div class="d-flex align-items-center gap-3">
        <input type="file" @change="handleImageUpload" accept="image/png, image/jpeg, image/jpg" class="form-control"
    ...
    <div class="mb-3">
      ...
      <textarea :value="eventForm.description"
        ...
        placeholder="Describe your event" rows="4" class="form-control"></textarea>
      <div class="form-text">
    ...
    <div class="mb-3">
      ...
      <input :value="eventForm.location"
        @input="$emit('update:eventForm', { ...eventForm, location: $event.target.value })" type="text"
        placeholder="Enter venue or location" class="form-control" :class="{ 'is-invalid': errors.location }" />
          ...
          <div class="col-12 col-md-6">
            <div class="row g-3">
              <div class="col-12 col-md-6">
                ...
                <input :value="eventForm.startDate"
                  @input="$emit('update:eventForm', { ...eventForm, startDate: $event.target.value })" type="date"
                  class="form-control" :class="{ 'is-invalid': errors.startDate }" :min="today" />
              ...
              <div class="col-12 col-md-6">
                ...
                <input :value="eventForm.startTime"
                  @input="$emit('update:eventForm', { ...eventForm, startTime: $event.target.value })" type="time"
                  class="form-control" :class="{ 'is-invalid': errors.startTime }" required />
          ...
          <div class="col-12 col-md-6">
            <div class="row g-3">
              <div class="col-12 col-md-6">
                ...
                <input :value="eventForm.endDate"
                  @input="$emit('update:eventForm', { ...eventForm, endDate: $event.target.value })" type="date"
                  class="form-control" :class="{ 'is-invalid': errors.endDate }" :min="today" />
              ...
              <div class="col-12 col-md-6">
                ...
                <input :value="eventForm.endTime"
                  @input="$emit('update:eventForm', { ...eventForm, endTime: $event.target.value })" type="time"
                  class="form-control" :class="{ 'is-invalid': errors.endTime }" required />
      ...
      <div class="card-body">
        <div class="row g-3">
          <div class="col-12 col-md-6">
            ...
            <input :value="eventForm.organizer"
              @input="$emit('update:eventForm', { ...eventForm, organizer: $event.target.value })" type="text"
              placeholder="Organizing company or person" class="form-control" />
          </div>
          <div class="col-12 col-md-6">
            <label class="form-label">
              Capacity <span class="text-danger">*</span>
            </label>
            <input :value="eventForm.capacity"
              @input="$emit('update:eventForm', { ...eventForm, capacity: parseInt($event.target.value) || 0 })"
              type="number" min="1" class="form-control" :class="{ 'is-invalid': errors.capacity }" />
        ...
        <div class="row g-3 mt-2">
          <div class="col-12 col-md-6">
            ...
            <select :value="eventForm.eventType"
              @change="$emit('update:eventForm', { ...eventForm, eventType: $event.target.value })" class="form-select"
          ...
          <div class="col-12 col-md-6 d-flex align-items-end">
            <div class="form-check">
              <input type="checkbox" class="form-check-input" id="isFreeEvent" :checked="eventForm.isFree"
