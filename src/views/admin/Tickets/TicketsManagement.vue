...
const deleteTicket = async (ticketId) => {
  ...
  try {
    ...
    alert('delete fall' + (err.message || 'please try later'))
  }
}
      ...
      <div v-else>
        ...
        <div class="mb-4">
          ...
          <div class="d-flex align-items-center">
            <span class="px-2 py-1 rounded-pill small fw-semibold" :class="{
        ...
        <div v-if="activeTab === 'ticketUsers'" class="bg-white rounded shadow-sm p-4">
          ...
          <div class="d-flex justify-content-start align-items-center mb-3">
            <input v-model="userSearchQuery" type="text" class="form-control" placeholder="Search ticket users..."
          ...
          <div class="table-responsive">
            <table class="table table-hover">
              <thead>
                <tr class="bg-light border-bottom">
                  <th class="px-3 py-2 text-start fs-6 text-muted" @click="userSortBy = 'name'; toggleUserSortOrder()"
                    style="cursor:pointer">
                    Name <i :class="userSortBy === 'name' ? (userSortOrder === 'asc' ? 'pi pi-sort-up' : 'pi pi-sort-down') : ''"
                      class="ms-1"></i>
                  </th>
                  ...
                  <th class="px-3 py-2 text-end fs-6 text-muted"
                    @click="userSortBy = 'purchaseDate'; toggleUserSortOrder()" style="cursor:pointer">
                    Purchase Date <i
                      :class="userSortBy === 'purchaseDate' ? (userSortOrder === 'asc' ? 'pi pi-sort-up' : 'pi pi-sort-down') : ''"
                      class="ms-1"></i>
                  </th>
                  <th class="px-3 py-2 text-center fs-6 text-muted">Actions</th>
                </tr>
              ...
              <tbody>
                <tr v-for="u in filteredTicketUsers" :key="u.id" class="border-bottom">
                  ...
                  <td class="px-3 py-2 text-center">
                    <div class="d-flex justify-content-center gap-2">
                      <button @click="viewTicketUserDetails(u.id)" class="btn btn-link text-primary p-0"><i
                          class="pi pi-eye"></i></button>
                      <button @click="deleteTicketUser(u.id)" class="btn btn-link text-danger p-0"><i
        ...
        <div v-if="activeTab === 'participants'" class="bg-white rounded shadow-sm p-4">
          ...
          <div class="d-flex justify-content-start align-items-center mb-3">
            <input v-model="participantSearchQuery" type="text" class="form-control"
              placeholder="Search participants..." style="max-width:300px;" />
          </div>
          <div class="table-responsive">
            <table class="table table-hover">
              <thead>
                <tr class="bg-light border-bottom">
                  <th class="px-3 py-2 text-start fs-6 text-muted"
                    @click="participantSortBy = 'name'; toggleParticipantSortOrder()" style="cursor:pointer">
                    Name <i
                      :class="participantSortBy === 'name' ? (participantSortOrder === 'asc' ? 'pi pi-sort-up' : 'pi pi-sort-down') : ''"
                      class="ms-1"></i>
                  </th>
                  <th class="px-3 py-2 text-start fs-6 text-muted">Email</th>
                  <th class="px-3 py-2 text-end fs-6 text-muted"
                    @click="participantSortBy = 'created_at'; toggleParticipantSortOrder()" style="cursor:pointer">
                    Registration Date <i
                      :class="participantSortBy === 'created_at' ? (participantSortOrder === 'asc' ? 'pi pi-sort-up' : 'pi pi-sort-down') : ''"
                      class="ms-1"></i>
                  </th>
                  <th class="px-3 py-2 text-center fs-6 text-muted">Actions</th>
                </tr>
              ...
              <tbody>
                <tr v-for="p in filteredParticipants" :key="p.id" class="border-bottom">
                  ...
                  <td class="px-3 py-2 text-center">
                    <div class="d-flex justify-content-center gap-2">
                      <button @click="viewParticipantDetails(p.id)" class="btn btn-link text-primary p-0"><i
                          class="pi pi-eye"></i></button>
                      <button @click="deleteParticipant(p.id)" class="btn btn-link text-danger p-0"><i
                          class="pi pi-trash"></i></button>
                    </div>
                  </td>
                </tr>
